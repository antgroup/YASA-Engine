 ...
 *
 */
class SpringInitializer extends JavaInitializer {
  static builtin = {
    ...super.builtin,
  }
   ...
   * @param dir
   */
  static async initBeans(topScope, dir) {
      ...
      if (xmlFile.content.includes('<bean') || xmlFile.content.includes('<sofa:')) {
        try {
          ...
          const parser = new xml2js.Parser({
            ...
            strict: false,
            tagNameProcessors: [
              (tagName) => tagName.toLowerCase(), // 将标签名转换为小写
            ],
          })
          ...
          if (springServices) {
            ...
            springServiceArray.forEach((springService) => {
          ...
          if (springReferences) {
            ...
            springReferenceArray.forEach((springReference) => {
...
module.exports = SpringInitializer
