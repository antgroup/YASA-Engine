...
const Statistics = {
  ...
  print() {
    ...
    printFileIssues(this.fileIssues, this.maindir)
 ...
 * @param maindir
 */
function printFileIssues(fileIssues, maindir) {
 ...
 * @param fname
 */
Statistics.incFileIssues = function (fname) {
