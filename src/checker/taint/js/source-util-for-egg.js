 ...
 * @param node
 */
function introduceTaintAtMemberAccess(res, scope, node) {
 ...
 * @param node
 */
function _introduceTaintAtMemberAccess(res, sourceScopeVal, node) {
  if (!BasicRuleHandler.getPreprocessReady()) {
    return
  }
 ...
 * @param node
 */
function markTaintAtMemberAccess(res, sourceScopeVal, node) {
