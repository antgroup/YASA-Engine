...
const realProjectRoot = process.env.YASA_JAVA_REAL_PROJECT_ROOT
if (realProjectRoot) {
  runMultiProject(realProjectRoot)
}

// Set YASA_JAVA_REAL_PROJECT_ROOT to run the optional real-project suite.
// const dir = ''
